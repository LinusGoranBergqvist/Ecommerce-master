...
namespace Ecommerce_Project.Migrations
{
    ...
    [Migration("20230509192315_AddingDataToOrdersAndOrderitemsAndTicketsAndTicketMessages")]
    partial class AddingDataToOrdersAndOrderitemsAndTicketsAndTicketMessages
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ecommerce_Project.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DeliveryAdress = "Storgatan 1, 12345 Staden",
                            Email = "anna@exempel.com",
                            ExpireDate = "12/25",
                            FirstName = "Anna",
                            LastName = "Andersson",
                            ShippingRate = 100m,
                            TotalPriceEUR = 189.8m,
                            TotalPriceSEK = 1898m
                        });
                });
            ...
            modelBuilder.Entity("Ecommerce_Project.Models.Ticket", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Description = "Jag undrar när min order kommer fram?",
                            Title = "Fraktfråga",
                            UserEmail = "anna@exempel.com"
                        });
                });
            ...
            modelBuilder.Entity("Ecommerce_Project.Models.TicketMessage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            IsAdmin = true,
                            Text = "Hej, din order borde anlända inom 3-5 arbetsdagar.",
                            TicketId = 1
                        },
                        new
                        {
